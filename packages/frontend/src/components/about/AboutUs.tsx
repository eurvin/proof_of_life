        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <p>
              ...
              created and wrapped in an NFT, that is then transferred to a recipient owner. The
              owner can claim each payment after it falls due. The NFT by default is valueless; the
              value resides in the stream it contains.
            </p>
            <br />
            <p>
            ...
            <div>
              <p>
                The first application using Zn is this fun but practical Proof-of-Life, for parents
                of late teen / early 20s children that live away from home. They may be in 3rd level
